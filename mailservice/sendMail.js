...
const sendMail = (email,customerId, orderId, name, price, quantity, productname, unitprice, invoiceUrl) => {
  ...
  const paylink = `https://www.b2bhubindia.com/payments/upload-payment`
        ...
        <td class="content">
          ...
          <table class="order-details-table">
            ...
            <tr>
              ...
              <td style="width:fit-content">	₹ ${formatIndianNumber(price)}</td>
